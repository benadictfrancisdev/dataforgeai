      ...
      <DialogContent className="sm:max-w-md bg-gradient-to-br from-card via-card to-pink-500/5 border-pink-500/20">
        <DialogHeader>
          ...
          <DialogDescription className="text-base">
            Love using AIDataForge? Your support helps us build amazing features and keep the service running!
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col items-center gap-5 py-4">
          ...
          <p className="text-xs text-muted-foreground text-center max-w-xs leading-relaxed">
            Every contribution, big or small, helps us improve AIDataForge and bring more powerful analytics features to you. Thank you! 💜
          </p>
        </div>
      </DialogContent>
    </Dialog>
