...
const MODELS = {
  'complex': 'google/gemini-2.5-pro',      // Complex reasoning, multi-step analysis
  'balanced': 'openai/gpt-5-mini',          // Fast, balanced performance
  'fast': 'google/gemini-2.5-flash',        // Cost-effective, quick responses
  'lite': 'google/gemini-2.5-flash-lite',   // Fastest, simple queries
} as const;
...
function buildSystemPrompt(context?: string): string {
  return `You are DataForge AI, an expert data analyst with deep expertise in statistics, business intelligence, and data visualization.
